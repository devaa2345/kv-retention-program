...
rows3b=load('results_llama/*/*.jsonl')
out={"model":"meta-llama/Llama-3.2-3B-Instruct","n_rows":len(rows3b)}
...
out["replication"]=rep
json.dump(out,open("results_llama/analysis.json","w"),indent=2)
print("\nwrote results_llama/analysis.json")
