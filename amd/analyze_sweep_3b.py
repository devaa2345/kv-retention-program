...
rows = {}
for p in glob.glob('results3b/bits*/*.jsonl'):
...
import os
ph = json.load(open('results3b/posthoc.json')) if os.path.exists('results3b/posthoc.json') else {}
...
json.dump(table, open('results3b/sweep_table.json', 'w'), indent=2)
print("\nwrote results3b/sweep_table.json")
